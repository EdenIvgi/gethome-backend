...
{"isApartment":true/false,"price":number|null,"rooms":number|null,"city":"string"|null,"neighborhood":"string"|null,"street":"string"|null,"floor":number|null,"areaSqm":number|null,"phone":"string"|null,"petsAllowed":true/false/null,"parking":true/false/null,"balcony":true/false/null}
...
const QUICK_KEYWORDS = [
  'להשכרה', 'לשכירות', 'דירה', 'חדרים', 'חדר', 'סאבלט', 'sublet',
  'שותף', 'שותפה', 'למסירה', 'שכ"ד', 'שכירות', 'room', 'apartment',
